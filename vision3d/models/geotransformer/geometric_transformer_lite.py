...
from .geometric_structure_embedding import GeometricStructureEmbeddingV2


class GeometricTransformerLite(nn.Module):
    """Geometric Transformer Lite (GeoTransformerLite).
    ...
    def __init__(
        ...
        self.embedding = GeometricStructureEmbeddingV2(
            hidden_dim, sigma_d, sigma_a, angle_k, angle_reduction=angle_reduction
        )
