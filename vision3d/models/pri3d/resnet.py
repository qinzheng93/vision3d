...
def create_resnet10(num_classes, pretrained=False):
    model = ResNet(BasicBlock, [1, 1, 1, 1], num_classes)
    return model


def create_resnet18(nclasses, pretrained=False):
...
def create_resnet34(num_classes, pretrained=False):
...
def create_resnet50(num_classes, pretrained="imagenet"):
...
def create_resnet101(num_classes, pretrained=False):
